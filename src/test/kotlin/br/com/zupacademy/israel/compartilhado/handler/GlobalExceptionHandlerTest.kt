package br.com.zupacademy.israel.compartilhado.handler
...
internal class GlobalExceptionHandlerTest {
    ...
    internal fun `deve retornar 422 quando statusException for already existis`() {
        ...
        val resposta = GlobalExceptionHandler().handle(requestGeneric, alreadyExistsException)
    ...
    internal fun `deve retornar 400 quando statusException for invalid argument`() {
        ...
        val resposta = GlobalExceptionHandler().handle(requestGeneric, invalidArgumentException)
    ...
    internal fun `deve retornar 500 quando qualquer outro erro for lancado`() {
        ...
        val resposta = GlobalExceptionHandler().handle(requestGeneric, internalException)
